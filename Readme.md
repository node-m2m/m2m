...
m2m is a node.js communication library for developing client-server or pub-sub applications in the cloud or edge using the framework [node-m2m](https://www.node-m2m.com).
