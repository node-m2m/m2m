...
m2m is a node.js communication library for developing client-server or pub-sub applications using the *machine-to-machine* cloud and edge framework [node-m2m](https://www.node-m2m.com).
