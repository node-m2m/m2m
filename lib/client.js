...
const sec = (() => {
  ...
  const setPkgConfig = exports.setPkgConfig = (pl) => {
    ...
    try{
      ...
      console.log('Done. Please verify your package.json configuration.\n');
  ...
  const m2mRestart = exports.m2mRestart = function(args, m2m, cb){
    try{
      ...
      let tk = fs.readFileSync(path, 'utf8');
      ...
      m2mUtil.eventLog('m2m_log/log.txt','m2mRestart()', JSON.stringify(e));
  ...
  const m2mRestartAsync = exports.m2mRestartAsync = function(args, m2m, cb){
    ...
    fs.readFile(path, 'utf8', (err, tk) => {
      ...
      try{
        ...
        m2mUtil.eventLog('m2m_log/log.txt','m2mRestartAsync()', JSON.stringify(e));
        // no token found, redirect user to register w/ credentials
        console.log('Registering new user.\n');
